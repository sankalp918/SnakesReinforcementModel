...
from gameReinforcementModel import ReinforcementModelSnakesGame, Direction, Point
...
def train():
    ...
    record = 0
    agent = Agent()
    game = ReinforcementModelSnakesGame()
    while True:
        ...
        agent.train_short_memory(old_state, final_move, reward, state_new, game_over)

        agent.remember(old_state, final_move, reward, state_new, game_over)
