...
class ReinforcementModelSnakesGame:

    def __init__(self, width=640, height=480):
        self.width = width
        self.height = height
        self.display = pygame.display.set_mode((self.width, self.height))
        pygame.display.set_caption('Reinforcement Model')
    ...
    def _move(self, action):
        ...
        if np.array_equal(action, [1, 0, 0]):
            ...
            next_new_direction = (index + 1) % 4
            new_direction = clock_wise[next_new_direction]
        else:
            next_new_direction = (index - 1) % 4
            new_direction = clock_wise[next_new_direction]
